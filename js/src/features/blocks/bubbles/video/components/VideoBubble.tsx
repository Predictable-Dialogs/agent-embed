...
import type { VideoBubbleContent } from '@/schemas'
import { VideoBubbleContentType } from '@/schemas/features/blocks/bubbles/video/enums'
  ...
  return (
    <div class="flex flex-col animate-fade-in" ref={ref}>
      <div class="flex w-full items-center">
        <div class="flex relative z-10 items-start agent-host-bubble-wrapper overflow-hidden">
          <div
            class="flex items-center absolute px-4 py-2 bubble-typing agent-host-bubble z-10 "
            style={{
