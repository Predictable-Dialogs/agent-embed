...
import { PictureChoiceBlock } from '@/schemas/features/blocks/inputs/pictureChoice'
        ...
        <For each={filteredItems()}>
          {(item, index) => (
            <button
              ...
              data-itemid={item.id}
              class={
                'flex flex-col agent-picture-button focus:outline-none filter hover:brightness-90 active:brightness-75 justify-between  ' +
