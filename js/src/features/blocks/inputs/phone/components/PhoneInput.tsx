...
import type { PhoneNumberInputOptions } from '@/schemas'
...
export const PhoneInput = (props: PhoneInputProps) => {
  ...
  return (
    <div
      class={'flex items-end justify-between pr-2 agent-input'}
      data-testid="input"
      style={{
        'max-width': '400px',
      }}
    ...
    >
      <div class="flex">
        <div class="relative agent-country-select flex justify-center items-center">
