...
import type { PaymentInputOptions, RuntimeOptions } from '@/schemas'
...
export const StripePaymentForm = (props: Props) => {
  ...
  return (
    <form
      ...
      class="flex flex-col p-4 agent-input w-full items-center"
    >
      ...
      <Show when={message()}>
        <div class="agent-input-error-message mt-4 text-center animate-fade-in">
          {message()}
        </div>
      </Show>
    </form>
