...
} from '@/schemas/features/blocks/inputs/pictureChoice'
import { For, Show, createSignal, onMount } from 'solid-js'
import { Checkbox } from '../buttons/components/Checkbox'
import { SendButton } from '@/components'
import { isDefined, isEmpty, isSvgSrc } from '@/lib/utils'
        ...
        <For each={filteredItems()}>
          {(item, index) => (
            <div
              ...
              class={
                'flex flex-col focus:outline-none cursor-pointer select-none agent-selectable-picture' +
        ...
        >
          {(selectedItem, index) => (
            <div
              ...
              class={
                'flex flex-col focus:outline-none cursor-pointer select-none agent-selectable-picture selected'
              }
